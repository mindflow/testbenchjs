...
class TestBench extends TestTrigger {
    ...
    reset(parent) {
        parent.runFailTestList = new coreutil_v1.List();
        parent.runSuccessTestList = new coreutil_v1.List();

        parent.runTestFunctionList = new coreutil_v1.List();
        parent.runTestClassList = new coreutil_v1.List();
    }
}

const LOG$1 = new coreutil_v1.Logger("TestBench");
